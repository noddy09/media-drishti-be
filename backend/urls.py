...
urlpatterns = [
    ...
    path('api/manual-entries/', include('backend.manual_entries.urls')),
    path('api/auditlog/', include('backend.auditlog.urls')),
    path('api/downloads/', include('backend.downloads.urls')),
